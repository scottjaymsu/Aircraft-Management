...
```
cd existing_repo
git remote add origin https://gitlab.msu.edu/scottjay/netjets-web-application.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.msu.edu/scottjay/netjets-web-application/-/settings/integrations)
